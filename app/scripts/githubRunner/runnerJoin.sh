...
#Why $ Needs Escaping (\) Inside SSH
#must be like
#RUNNER_TOKEN=\$(...)
#Otherwise: It executes locally instead of remotely ❌

#other method to use above things
# sshpass -p "${2}" ssh -o StrictHostKeyChecking=no ubuntu@$worker01IP "bash -s" -- "${1}" << 'EOF'
# -----commands-------------
# EOF